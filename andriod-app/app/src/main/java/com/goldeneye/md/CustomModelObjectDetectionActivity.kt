...
import com.goldeneye.md.camera.GraphicOverlay
import com.goldeneye.md.camera.WorkflowModel
import com.goldeneye.md.camera.WorkflowModel.WorkflowState
import com.goldeneye.md.camera.CameraSource
import com.goldeneye.md.camera.CameraSourcePreview
import com.goldeneye.md.objectdetection.MultiObjectProcessor
import com.goldeneye.md.objectdetection.ProminentObjectProcessor
import com.goldeneye.md.productsearch.BottomSheetScrimView
import com.goldeneye.md.productsearch.ProductAdapter
import com.goldeneye.md.productsearch.SearchEngine
import com.goldeneye.md.settings.PreferenceUtils
...
//            }
    ...
    private fun setUpWorkflowModel() {
        workflowModel = ViewModelProviders.of(this).get(WorkflowModel::class.java).apply {
            ...
            /**
             * this is the place to tap into search.
             */
